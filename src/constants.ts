import { PlayerColorsType, TileMapArrType, TileType, StartingTilesForEachPlayerType, PlayerPosType, AnimatingTilesType, PiecesPosType } from "./types";
...
export const TileMap: TileMapArrType = [
    [
        { ...T1, id: 0 },
        { ...T1, id: 1 },
        { ...T1, id: 2 },
...
export const ArrowTiles = [217, 105, 7, 119];
export const StartingTilesForEachPlayer: StartingTilesForEachPlayerType = {
    player1: 201,
    player2: 91,
    player3: 23,
    player4: 133
...
export const PlayerActiveAnimatingTiles: AnimatingTilesType = {
    player1: [
...
export const EntryToSafeZoneTiles = {
    player1: 217,
    player2: 105,
    player3: 7,
    player4: 119
...
export const CanMove: PiecesPosType = {
    p1: -1,
    p2: -1,
    p3: -1,
    p4: -1
